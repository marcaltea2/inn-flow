...
import { createStaffSchema, type CreateStaffInput } from "~/server/validations/staff-validation";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new staff login. They&apos;ll sign in with the email and password set here.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="firstName" {...form.register("firstName")} autoComplete="off" />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="lastName" {...form.register("lastName")} autoComplete="off" />
